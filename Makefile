...
run:
	emcc main.cpp --shell-file shell_minimal.html -o public/templates/home.html -L . -I . -lraylib -s ASYNCIFY -s USE_GLFW=3 -DPLATFORM_WEB -O3 -ffast-math -pipe -fno-plt -fexceptions -Wp,-D_FORTIFY_SOURCE=3 -Wformat -Werror=format-security -fno-omit-frame-pointer -mno-omit-leaf-frame-pointer
